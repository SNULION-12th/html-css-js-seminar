...
//과제 구현 4) 스토리 모달 해제 기능
storyModal.addEventListener("click", function (event) {
  if (event.target.className == "story-image") {
    return;
  } else {
...
//과제 구현 3) 알림창
const push = document.querySelector(".push-container");
...
const emojiBtn = document.querySelector(".smile");
